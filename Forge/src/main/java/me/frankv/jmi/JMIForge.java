...
import me.frankv.jmi.config.ForgeClientConfig;
...
public class JMIForge {
    public static final ForgeClientConfig CLIENT_CONFIG = new ForgeClientConfig();
    ...
    private void registerEvent() {
        ...
        MinecraftForge.EVENT_BUS.addListener((InputEvent.MouseButton.Post e) -> {
